...
class Question6Fragment : Fragment() {
    private var contentIndex = 5
    private lateinit var portraitImage: ImageView

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View? {
        activity?.findViewById<Toolbar>(R.id.toolbar)?.title = getString(R.string.question_6_title)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        portraitImage.setImageResource(R.drawable.q6_image)
